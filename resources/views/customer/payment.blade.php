...
@section('title', 'Payment - Tracklane')
...
<div style="background:#F8FAFC; padding:18px 22px; min-height:560px;">
    ...
    <div style="max-width:700px; margin:0 auto;">
        ...
        <div style="display:flex; align-items:center; gap:12px; margin-bottom:16px;">
            <a href="{{ route('customer.orders') }}" style="color:#64748B; text-decoration:none; font-size:20px;">
        ...
        <div style="background:#FFFFFF; border:0.5px solid #E2E8F0; border-radius:16px; padding:20px; margin-bottom:16px;">
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:12px;">
                <div>
                    ...
                    <div style="font-size:14px; font-weight:500; color:#0F172A;">{{ $order->order_number }}</div>
                </div>
                <div>
        ...
        <!-- ============================================================
             PAYMENT METHOD
             ============================================================ -->
        <form method="POST" action="{{ route('customer.process-payment', $order->id) }}" id="paymentForm">
            @csrf
            ...
            <div style="background:#FFFFFF; border:0.5px solid #E2E8F0; border-radius:16px; padding:20px; margin-bottom:16px;">
                ...
                <div class="mobile-money-fields" id="mobileMoneyFields">
                    ...
                    <div class="field">
                        ...
                        <input type="tel" name="phone_number" placeholder="e.g., 690000000" value="{{ Auth::user()->phone ?? '' }}">
                    </div>
            ...
            <button type="submit" 
                ...
                <i class="ti ti-credit-card"></i> Pay {{ number_format($order->total_price ?? 0, 0, ',', ' ') }} F
            </button>
