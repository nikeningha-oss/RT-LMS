...
@section('title', 'Create Order - Tracklane')
@section('page-title', 'Create New Delivery')
...
<div style="background:#F8FAFC; padding:18px 22px; min-height:560px;">
    ...
    <div style="max-width:1100px; margin:0 auto;">
        ...
        <div style="background:#FFFFFF; border:0.5px solid #E2E8F0; border-radius:16px; padding:24px;">
            ...
            <form method="POST" action="{{ route('customer.store-order') }}" id="orderForm">
                @csrf
                ...
                <!-- ============================================================
                     DISTANCE DISPLAY
                     ============================================================ -->
                <div class="distance-display-large" id="distanceDisplay" style="{{ old('distance_km') ? '' : 'display:none;' }}">
                    <span class="label-icon">
                        <i class="ti ti-route" style="font-size:18px; color:#14B8A6;"></i> 
                        Distance between pickup & drop-off
                    </span>
                    <span class="value" id="distanceText">{{ old('distance_km') ? number_format(old('distance_km'), 1) : '0' }} km</span>
                </div>
                ...
                <div style="margin:16px 0;">
                    ...
                    <textarea name="description" 
                              ...
                              rows="2"
                              style="width:100%; padding:10px 14px; border:0.5px solid #E2E8F0; border-radius:8px; font-size:14px; font-family:inherit;">{{ old('description') }}</textarea>
                    @error('description')
                        <div style="color:#E24B4A; font-size:12px; margin-top:4px;">{{ $message }}</div>
                    @enderror
                </div>
...
<script>
    ...
    var maptilerKey = '{{ env("MAPTILER_KEY") }}';
