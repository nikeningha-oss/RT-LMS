...
@section('title', 'Edit Customer - Tracklane')
...
<div style="background:#F8FAFC; padding:18px 22px; min-height:560px;">
    ...
    <div style="max-width:600px; margin:0 auto;">
        ...
        <div style="display:flex; align-items:center; gap:12px; margin-bottom:16px;">
            <a href="{{ route('admin.customers') }}" style="color:#64748B; text-decoration:none; font-size:20px;">
                ...
                <div style="margin-bottom:20px;">
                    ...
                    <div style="display:flex; gap:16px;">
                        <label style="font-size:13px; color:#0F172A; display:flex; align-items:center; gap:6px;">
                            <input type="radio" name="is_active" value="1" {{ $customer->is_available ? 'checked' : '' }}> 
                            <span style="color:#10B981;">🟢 Active</span>
                        </label>
                        <label style="font-size:13px; color:#0F172A; display:flex; align-items:center; gap:6px;">
                            <input type="radio" name="is_active" value="0" {{ !$customer->is_available ? 'checked' : '' }}> 
