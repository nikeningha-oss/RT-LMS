...
<?php $__env->startSection('title', 'My Orders - Tracklane'); ?>
                    ...
                    <tr style="border-bottom:0.5px solid #E2E8F0;">
                        <td style="padding:8px; font-weight:500; color:#0F172A;">
                            ...
                            <span class="price-breakdown-toggle" onclick="toggleBreakdown(<?php echo e($order->id); ?>)">
                                <i class="ti ti-chevron-down" id="toggleIcon<?php echo e($order->id); ?>"></i> View Price Breakdown
                            </span>
                        </td>
                        <td style="padding:8px; color:#64748B;"><?php echo e(Str::limit($order->pickup_address, 15)); ?></td>
                        <td style="padding:8px; color:#64748B;"><?php echo e(Str::limit($order->delivery_address, 15)); ?></td>
                        <td style="padding:8px; color:#64748B;"><?php echo e($order->distance_km ?? 0); ?> km</td>
                        <td style="padding:8px; color:#64748B;"><?php echo e($order->weight_kg ?? 0); ?> kg</td>
                        <td style="padding:8px;">
                            ...
                            ?>
                            <span style="padding:3px 8px; border-radius:12px; font-size:11px; <?php echo e($statusStyles[$order->status] ?? 'background:#F1F5F9;color:#475569;'); ?>">
                        ...
                        <td colspan="8" style="padding:4px 8px 12px 8px;">
                            <div class="price-breakdown-box show" id="breakdownBox<?php echo e($order->id); ?>">
                                <div style="font-size:13px; font-weight:600; color:#0F172A; margin-bottom:6px;">
                                    💰 Price Breakdown - <?php echo e($order->order_number); ?>
                                ...
                                <div style="margin-top:6px; padding-top:6px; border-top:1px solid #E2E8F0; font-size:11px; color:#94A3B8;">
                                    <i class="ti ti-route"></i> Distance: <?php echo e($order->distance_km ?? 0); ?> km | 
                                    <i class="ti ti-weight"></i> Weight: <?php echo e($order->weight_kg ?? 0); ?> kg
                                    <?php if($order->status === 'delivered'): ?>
                                        | <i class="ti ti-check-circle" style="color:#10B981;"></i> Delivered on <?php echo e(optional($order->actual_delivery)->format('M d, Y h:i A') ?? 'N/A'); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\logistics_system\resources\views/customer/orders.blade.php ENDPATH**/ ?>