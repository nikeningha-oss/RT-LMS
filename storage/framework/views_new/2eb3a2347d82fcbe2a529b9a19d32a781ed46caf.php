...
<body>
            ...
            <div class="d-flex align-items-center justify-content-between w-100">
                ...
                <div class="d-flex align-items-center gap-2">
                    <?php if(Auth::check()): ?>
                        ...
                        <a href="<?php echo e(route('dashboard')); ?>" class="btn-hero-primary" style="padding: 8px 20px; font-size: 14px;">
                            <i class="ti ti-layout-dashboard"></i> Dashboard
                        </a>
                    <?php else: ?>
                        <!-- If not logged in, show login and register -->
                        <a href="<?php echo e(route('login')); ?>" class="text-decoration-none" style="color: var(--color-text-secondary); font-weight: 500; font-size: 14px; padding: 8px 16px;">
                            Sign In
                        </a>
                        <a href="<?php echo e(route('register')); ?>" class="btn-hero-primary" style="padding: 8px 20px; font-size: 14px;">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="hero-buttons">
                        <?php if(Auth::check()): ?>
                            <a href="<?php echo e(route('dashboard')); ?>" class="btn-hero-primary">
    ...
    <section class="cta-section">
        <div class="container text-center">
            ...
            <?php if(Auth::check()): ?>
                <a href="<?php echo e(route('dashboard')); ?>" class="btn-cta">
                    <i class="ti ti-layout-dashboard"></i> Go to Dashboard
                </a>
            <?php else: ?>
...
</html><?php /**PATH C:\xampp\htdocs\logistics_system\resources\views/index.blade.php ENDPATH**/ ?>