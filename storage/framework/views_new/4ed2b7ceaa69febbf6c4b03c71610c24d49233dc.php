...
<?php $__env->startSection('title', 'Manage Customers - Tracklane'); ?>
...
<div style="background:#F8FAFC; padding:18px 22px; min-height:560px;">
    ...
    <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:16px;">
        ...
        <div style="display:flex; gap:8px;">
            <span style="background:#CCFBF1; color:#0D9488; padding:4px 12px; border-radius:12px; font-size:12px;">
                Total: <?php echo e(isset($customers) ? $customers->count() : 0); ?>
    ...
    <div style="display:grid; grid-template-columns:repeat(4,minmax(0,1fr)); gap:8px; margin-bottom:16px;">
        <div style="background:#FFFFFF; border:0.5px solid #E2E8F0; border-radius:8px; padding:8px 12px; text-align:center;">
            ...
            <div style="font-size:16px; font-weight:600; color:#0F172A;"><?php echo e($totalCustomers); ?></div>
        </div>
        <div style="background:#FFFFFF; border:0.5px solid #E2E8F0; border-radius:8px; padding:8px 12px; text-align:center;">
            <div style="font-size:10px; color:#64748B;">✅ Active</div>
            <div style="font-size:16px; font-weight:600; color:#10B981;"><?php echo e($activeCustomers); ?></div>
        </div>
        <div style="background:#FFFFFF; border:0.5px solid #E2E8F0; border-radius:8px; padding:8px 12px; text-align:center;">
            <div style="font-size:10px; color:#64748B;">⏳ Pending</div>
            <div style="font-size:16px; font-weight:600; color:#F59E0B;"><?php echo e($pendingCustomers); ?></div>
        </div>
        <div style="background:#FFFFFF; border:0.5px solid #E2E8F0; border-radius:8px; padding:8px 12px; text-align:center;">
            <div style="font-size:10px; color:#64748B;">❌ Rejected</div>
            <div style="font-size:16px; font-weight:600; color:#E24B4A;"><?php echo e($rejectedCustomers); ?></div>
        </div>
    </div>
            ...
            <table style="width:100%; font-size:12px; border-collapse:collapse;">
                ...
                <tbody>
                    ...
                    <tr style="border-bottom:0.5px solid #E2E8F0;">
                        <td style="padding:8px; font-weight:500; color:#0F172A;">
                            <div style="display:flex; align-items:center; gap:8px;">
                                <div style="width:28px; height:28px; border-radius:50%; background:#CCFBF1; display:flex; align-items:center; justify-content:center; font-size:11px; font-weight:600; color:#0D9488;">
                                    <?php echo e(strtoupper(substr($customer->name ?? 'N/A', 0, 2))); ?>
                        ...
                        <td style="padding:8px; color:#64748B;"><?php echo e($customer->email ?? 'N/A'); ?></td>
                        <td style="padding:8px; color:#64748B;"><?php echo e($customer->phone ?? 'N/A'); ?></td>
                        ...
                        <td style="padding:8px; text-align:center;">
                            <div style="display:flex; gap:4px; justify-content:center; flex-wrap:wrap;">
                                ...
                                <button data-customer-id="<?php echo e($customer->id); ?>" 
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\logistics_system\resources\views/admin/customers.blade.php ENDPATH**/ ?>