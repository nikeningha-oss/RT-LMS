...
<?php $__env->startSection('title', 'Driver Dashboard - Tracklane'); ?>
...
<div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:24px; flex-wrap:wrap; gap:12px;">
    <div>
        ...
        <div style="font-size:13px; color:#64748B; margin-top:2px;">
            <?php if($driverProfile && $driverProfile->vehicle): ?>
                <?php echo e($driverProfile->vehicle->model ?? 'Vehicle'); ?> · <?php echo e($driverProfile->vehicle->plate_number ?? 'N/A'); ?>
    ...
    <div style="display:flex; align-items:center; gap:10px; flex-wrap:wrap;">
        ...
        <div class="status-toggle-container">
            <div class="status-dot <?php echo e($statusClass); ?>"></div>
            <span class="status-text <?php echo e($statusClass); ?>"><?php echo e($statusText); ?></span>
            <form method="POST" action="<?php echo e(route('driver.toggle-status')); ?>" style="display:inline; margin:0;">
                <?php echo csrf_field(); ?>
                <button type="submit" class="toggle-btn <?php echo e($statusClass); ?>">
                    <div class="toggle-slider <?php echo e($statusClass); ?>"></div>
                </button>
            </form>
        </div>
    </div>
...
<div class="stats-grid">
    <div class="stat-card-driver">
        ...
        <div class="stat-value" id="todayEarnings"><?php echo e(number_format($todayEarnings ?? 0, 0, ',', ' ')); ?> F</div>
    ...
    <div class="stat-card-driver">
        ...
        <div class="stat-value" id="completedToday"><?php echo e($completedToday ?? 0); ?></div>
        <div class="stat-change positive">
    ...
    <div class="stat-card-driver">
        ...
        <div class="stat-value" id="totalDeliveries"><?php echo e($totalCompleted ?? 0); ?></div>
    ...
    <div class="stat-card-driver">
        ...
        <div class="stat-value" id="totalEarnings"><?php echo e(number_format($totalEarnings ?? 0, 0, ',', ' ')); ?> F</div>
        <div class="stat-change neutral">
...
<div class="earnings-card">
    ...
    <div class="earnings-grid">
        <div class="earnings-item" style="border-left-color:#10B981;">
            ...
            <div class="value green"><?php echo e(number_format($todayEarnings ?? 0, 0, ',', ' ')); ?> F</div>
        </div>
        <div class="earnings-item" style="border-left-color:#3B82F6;">
            <div class="label">Total Earnings</div>
            <div class="value blue"><?php echo e(number_format($totalEarnings ?? 0, 0, ',', ' ')); ?> F</div>
        </div>
        <div class="earnings-item" style="border-left-color:#F59E0B;">
            <div class="label">Total Deliveries</div>
            <div class="value amber"><?php echo e($totalCompleted ?? 0); ?></div>
        </div>
        <div class="earnings-item" style="border-left-color:#8B5CF6;">
            <div class="label">Avg Per Delivery</div>
            <div class="value purple"><?php echo e(number_format($avgPerDelivery, 0, ',', ' ')); ?> F</div>
        </div>
    </div>
...
<div style="background:#FFFFFF; border:0.5px solid #E2E8F0; border-radius:12px; padding:18px 20px; margin-top:20px;">
    <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:14px; flex-wrap:wrap; gap:8px;">
        ...
        <a href="<?php echo e(route('driver.withdraw')); ?>" 
    ...
    <div class="balance-grid">
        <div style="background:#F8FAFC; border-radius:8px; padding:12px 14px; text-align:center; border:0.5px solid #E2E8F0;">
            ...
            <div style="font-size:22px; font-weight:700; color:#10B981; margin-top:2px;">
                <?php echo e(isset($driverProfile) ? number_format($driverProfile->available_balance ?? 0, 0, ',', ' ') : '0'); ?> F
            </div>
        </div>
        <div style="background:#F8FAFC; border-radius:8px; padding:12px 14px; text-align:center; border:0.5px solid #E2E8F0;">
            ...
            <div style="font-size:22px; font-weight:700; color:#0F172A; margin-top:2px;">
                <?php echo e(isset($driverProfile) ? number_format($driverProfile->total_earned ?? 0, 0, ',', ' ') : '0'); ?> F
            </div>
        </div>
        <div style="background:#F8FAFC; border-radius:8px; padding:12px 14px; text-align:center; border:0.5px solid #E2E8F0;">
            ...
            <div style="font-size:22px; font-weight:700; color:#F59E0B; margin-top:2px;">
                <?php echo e(isset($driverProfile) ? number_format($driverProfile->total_withdrawn ?? 0, 0, ',', ' ') : '0'); ?> F
            </div>
        </div>
    </div>

    <?php if(isset($driverProfile) && $driverProfile->available_balance > 0): ?>
    <div style="margin-top:12px; display:flex; gap:10px; flex-wrap:wrap;">
        ...
        <a href="<?php echo e(route('driver.withdrawals')); ?>" 
    ...
    <div class="delivery-header">
        <div style="display:flex; align-items:center; gap:10px; flex-wrap:wrap;">
            ...
            <span class="delivery-status in-transit">
                <i class="ti ti-truck" style="font-size:12px;"></i> <?php echo e(ucfirst(str_replace('_', ' ', $activeOrder->status))); ?>

            </span>
        </div>
        <span style="font-size:12px; color:#64748B; font-weight:500;">#<?php echo e($activeOrder->order_number); ?></span>
    </div>
        ...
        <div style="display:flex; flex-direction:column; gap:8px; justify-content:space-between;">
            <div>
                <div class="delivery-address-item">
                    ...
                    <?php echo e(Str::limit($activeOrder->pickup_address, 35)); ?>
            ...
            <div>
                <div class="delivery-address-item">
                    ...
                    <strong><?php echo e(Str::limit($activeOrder->delivery_address, 35)); ?></strong>
                </div>
            </div>
            <div>
                <div class="delivery-address-item">
                    <span class="label"><i class="ti ti-user"></i> Customer</span>
                    <?php echo e($activeOrder->customer->name ?? 'N/A'); ?>

                    <?php if($activeOrder->customer && $activeOrder->customer->phone): ?>
                        · <?php echo e($activeOrder->customer->phone); ?>
            ...
            <div style="display:flex; gap:10px; margin-top:6px; flex-wrap:wrap;">
                <a href="<?php echo e(route('tracking', $activeOrder->id)); ?>" 
                   class="btn-outline" style="flex:1; min-width:100px;">
                    <i class="ti ti-map"></i> Track Live
                </a>
                
                <?php if($activeOrder->status !== 'delivered'): ?>
                <form method="POST" action="<?php echo e(route('driver.update-status', $activeOrder->id)); ?>" style="flex:1; min-width:100px;">
                    <?php echo csrf_field(); ?>
...
<div style="background:#FFFFFF; border:0.5px solid #E2E8F0; border-radius:16px; padding:20px; margin-top:20px;">
    <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:16px; flex-wrap:wrap; gap:8px;">
        <div class="section-title">
            ...
            <span class="section-badge"><?php echo e($completedToday ?? 0); ?> today</span>
        </div>
    </div>
    
    <?php if(isset($recentCompleted) && $recentCompleted->count() > 0): ?>
    <div style="overflow-x:auto;">
        <table class="table-driver">
            ...
            <tbody>
                <?php $__currentLoopData = $recentCompleted; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td style="font-weight:500; color:#0F172A;">#<?php echo e($order->order_number); ?></td>
                    <td><?php echo e($order->customer->name ?? 'N/A'); ?></td>
                    <td style="color:#64748B;"><?php echo e($order->distance_km ?? 0); ?> km</td>
                    <td style="color:#64748B;"><?php echo e($order->weight_kg ?? 0); ?> kg</td>
                    <td style="color:#64748B;">
                        <?php echo e(optional($order->updated_at)->format('d M Y, h:i A') ?? 'N/A'); ?>

                    </td>
                    <td style="text-align:right; font-weight:600; color:#10B981;">
                        <?php echo e(number_format($order->driver_earning ?? 0, 0, ',', ' ')); ?> F
                    </td>
                </tr>
...
<!-- ============================================================
     ...
     ============================================================ -->
<?php if($isOnline && isset($activeOrder) && $activeOrder): ?>
<script>
    (function() {
        'use strict';
        ...
        var orderId = '<?php echo e($activeOrder->id); ?>';
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\logistics_system\resources\views/dashboard/driver.blade.php ENDPATH**/ ?>