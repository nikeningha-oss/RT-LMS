...
<?php $__env->startSection('title', 'Request Withdrawal - Tracklane'); ?>
    ...
    <div style="background:#F8FAFC; padding:20px 24px; min-height:560px;">
        ...
        <div style="max-width:600px; margin:0 auto;">
            ...
            <div style="display:flex; align-items:center; gap:12px; margin-bottom:20px;">
                <a href="<?php echo e(route('driver.dashboard')); ?>" style="color:#64748B; text-decoration:none; font-size:20px;">
            ...
            <div class="balance-card">
                ...
                <div class="balance-amount"><?php echo e($driver->formatted_available_balance ?? '0 F'); ?></div>
                <div class="balance-details">
                    <div class="detail-item">
                        Total Earned: <strong><?php echo e($driver->formatted_total_earnings ?? '0 F'); ?></strong>
                    </div>
                    <div class="detail-item">
                        Total Withdrawn: <strong><?php echo e($driver->formatted_total_withdrawn ?? '0 F'); ?></strong>
                    </div>
                </div>
            </div>
            ...
            <div style="background:#FFFFFF; border:0.5px solid #E2E8F0; border-radius:16px; padding:24px;">
                ...
                <form method="POST" action="<?php echo e(route('driver.withdraw.store')); ?>" id="withdrawForm">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                               ...
                               min="1"
                               max="<?php echo e($driver->available_balance ?? 0); ?>"
                        ...
                        <div class="form-hint">
                            ...
                            <br>
                            <span style="color:#64748B;">Minimum: 1 F · Maximum: <?php echo e(number_format($driver->available_balance ?? 0, 0, ',', ' ')); ?> F</span>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" 
                               ...
                               class="form-input <?php $__errorArgs = ['account_details'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="text-align:center; margin-top:16px;">
                <a href="<?php echo e(route('driver.withdrawals')); ?>" style="color:#14B8A6; text-decoration:none; font-size:13px;">
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\logistics_system\resources\views/driver/withdraw.blade.php ENDPATH**/ ?>