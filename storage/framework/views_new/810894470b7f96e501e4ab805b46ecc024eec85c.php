...
<div style="background:#F8FAFC; padding:18px 22px; min-height:560px;">
    ...
    <div class="stats-grid">
        <div class="stat-box">
            ...
            <div class="value"><?php echo e($orders->count() ?? 0); ?></div>
        </div>
        <div class="stat-box">
            <div class="label">In Transit</div>
            <div class="value blue"><?php echo e($orders->where('status', 'in_transit')->count() ?? 0); ?></div>
        </div>
        <div class="stat-box">
            <div class="label">Delivered</div>
            <div class="value green"><?php echo e($totalDeliveries); ?></div>
        </div>
        <div class="stat-box">
            <div class="label">Total Earned</div>
            <div class="value green"><?php echo e(number_format($totalEarned, 0, ',', ' ')); ?> F</div>
        </div>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="color:#64748B; max-width:100px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;">
                            <?php echo e(Str::limit($order->pickup_address, 15)); ?>

                        </td>
                        <td style="color:#64748B; max-width:100px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;">
                            <?php echo e(Str::limit($order->delivery_address, 15)); ?>
                        ...
                        <td style="color:#64748B;">
                            <?php echo e(optional($order->created_at)->format('M d, Y') ?? 'N/A'); ?>
                        ...
                        <td style="text-align:center;">
                            <?php if($order->status === 'assigned' || $order->status === 'picked_up' || $order->status === 'in_transit'): ?>
                                <button onclick="updateStatus(<?php echo e($order->id); ?>, 'delivered')" 
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(route('tracking', $order->id)); ?>" class="view-details-btn">
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\logistics_system\resources\views/driver/orders.blade.php ENDPATH**/ ?>