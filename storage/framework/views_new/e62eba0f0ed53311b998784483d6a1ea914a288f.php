...
<?php $__env->startSection('title', 'Withdrawal History - Tracklane'); ?>
    ...
    <div style="background:#F8FAFC; padding:20px 24px; min-height:560px;">
        ...
        <div class="balance-summary">
            <div class="summary-card">
                ...
                <div class="value green"><?php echo e($driver->formatted_available_balance ?? '0 F'); ?></div>
            </div>
            <div class="summary-card">
                <div class="label">📦 Total Earned</div>
                <div class="value blue"><?php echo e($driver->formatted_total_earnings ?? '0 F'); ?></div>
            </div>
            <div class="summary-card">
                <div class="label">💸 Total Withdrawn</div>
                <div class="value orange"><?php echo e($driver->formatted_total_withdrawn ?? '0 F'); ?></div>
            </div>
            <div class="summary-card">
                <div class="label">📊 Total Requests</div>
                <div class="value purple"><?php echo e($withdrawals->count() ?? 0); ?></div>
            </div>
        </div>
        ...
        <div style="background:#FFFFFF; border:0.5px solid #E2E8F0; border-radius:16px; padding:20px;">
            ...
            <?php if(isset($withdrawals) && $withdrawals->count() > 0): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <span style="display:flex; align-items:center; gap:6px;">
                                    ...
                                    <?php endif; ?>
                                    <?php echo e($withdrawal->account_details); ?>

                                </span>
                            </td>
                            <td>
                                <span class="badge-<?php echo e($withdrawal->status); ?>">
                                    <span class="status-dot <?php echo e($withdrawal->status); ?>"></span>
                                    <?php echo e($withdrawal->status_label); ?>
            ...
            <div class="empty-state">
                ...
                <a href="<?php echo e(route('driver.withdraw')); ?>" style="color:#14B8A6; text-decoration:none; margin-top:8px; display:inline-block;">
            ...
            <div style="margin-top:16px; text-align:center;">
                <a href="<?php echo e(route('driver.dashboard')); ?>" style="color:#64748B; text-decoration:none; font-size:13px;">
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\logistics_system\resources\views/driver/withdrawals.blade.php ENDPATH**/ ?>