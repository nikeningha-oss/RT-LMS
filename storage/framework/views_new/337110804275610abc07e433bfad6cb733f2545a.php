...
<?php $__env->startSection('title', 'Admin Dashboard - Tracklane'); ?>
        ...
        <div style="background:var(--gray-50); padding:20px 24px; min-height:560px;">
            ...
            <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:20px; flex-wrap:wrap; gap:12px;">
                <div>
                    ...
                    <div style="font-size:13px; color:var(--gray-500);">Welcome back, <?php echo e(Auth::user()->name); ?>!</div>
                </div>
            ...
            <div class="summary-stats-grid">
                <div class="summary-item">
                    ...
                    <div class="summary-value blue"><?php echo e(number_format($totalDrivers ?? 0)); ?></div>
                </div>
                <div class="summary-item">
                    <div class="summary-label">👤 Total Customers</div>
                    <div class="summary-value primary"><?php echo e(number_format($totalCustomers ?? 0)); ?></div>
                </div>
                <div class="summary-item">
                    <div class="summary-label">📦 Total Orders</div>
                    <div class="summary-value orange"><?php echo e(number_format($totalOrdersCount ?? 0)); ?></div>
                </div>
                <div class="summary-item">
                    <div class="summary-label">✅ Delivered Orders</div>
                    <div class="summary-value green"><?php echo e(number_format($deliveredOrders ?? 0)); ?></div>
                </div>
            </div>
            ...
            <div class="stats-grid">
                <div class="stat-card-admin">
                    ...
                    <div class="value"><?php echo e(number_format($activeDeliveries ?? 0)); ?></div>
                    <div class="change positive"><i class="ti ti-arrow-up"></i> +<?php echo e(number_format($todayOrders ?? 0)); ?> today</div>
                </div>
                <div class="stat-card-admin">
                    <div class="stat-icon"><i class="ti ti-user-check"></i></div>
                    <div class="label">Online Drivers</div>
                    <div class="value"><?php echo e(number_format($onlineDrivers ?? 0)); ?></div>
                    <div class="change neutral"><?php echo e(number_format($idleDrivers ?? 0)); ?> idle</div>
                </div>
                <div class="stat-card-admin">
                    <div class="stat-icon"><i class="ti ti-clock"></i></div>
                    <div class="label">Avg Delivery Time</div>
                    <div class="value"><?php echo e(isset($avgDeliveryTime) ? round($avgDeliveryTime) : 0); ?> min</div>
                ...
                <div class="stat-card-admin">
                    ...
                    <div class="value"><?php echo e(number_format($deliveredOrders ?? 0)); ?></div>
            ...
            <div class="earnings-grid">
                <div class="earnings-card" style="border-left-color:var(--primary);">
                    ...
                    <div class="value total"><?php echo e(number_format($todayRevenue ?? 0, 0, ',', ' ')); ?> F</div>
                ...
                <div class="earnings-card" style="border-left-color:var(--success);">
                    ...
                    <div class="value driver"><?php echo e(number_format($todayDriverEarnings ?? 0, 0, ',', ' ')); ?> F</div>
                ...
                <div class="earnings-card" style="border-left-color:#3B82F6;">
                    ...
                    <div class="value platform"><?php echo e(number_format($todayPlatformEarnings ?? 0, 0, ',', ' ')); ?> F</div>
            ...
            <div style="display:grid; grid-template-columns:repeat(3,1fr); gap:12px; margin-bottom:16px;">
                <div class="summary-item">
                    ...
                    <div class="summary-value primary"><?php echo e(number_format($monthlyRevenue ?? 0, 0, ',', ' ')); ?> F</div>
                </div>
                <div class="summary-item">
                    <div class="summary-label">👨‍✈️ Monthly Driver Earnings</div>
                    <div class="summary-value green"><?php echo e(number_format($monthlyDriverEarnings ?? 0, 0, ',', ' ')); ?> F</div>
                </div>
                <div class="summary-item">
                    <div class="summary-label">🏢 Monthly Platform Earnings</div>
                    <div class="summary-value blue"><?php echo e(number_format($monthlyPlatformEarnings ?? 0, 0, ',', ' ')); ?> F</div>
                </div>
            </div>
            ...
            <div style="background:#FFFFFF; border:0.5px solid var(--gray-200); border-radius:12px; padding:18px 20px; margin-bottom:16px;">
                <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:14px; flex-wrap:wrap; gap:8px;">
                    <div>
                        ...
                        <div style="font-size:12px; color:var(--gray-400); margin-top:2px;">
                            Total: <?php echo e(number_format($totalDriverEarningsThisMonth ?? 0, 0, ',', ' ')); ?> F
                        </div>
                    </div>
                    <div style="display:flex; gap:6px; flex-wrap:wrap;">
                        <span style="font-size:11px; color:var(--gray-500); background:var(--gray-100); padding:4px 12px; border-radius:20px;">
                            <i class="ti ti-calendar"></i> <?php echo e(now()->format('M Y')); ?>

                        </span>
                        <span style="font-size:11px; color:var(--success); background:var(--success-bg); padding:4px 12px; border-radius:20px;">
                            <i class="ti ti-check"></i> <?php echo e($driverEarningsThisMonth->where('status', 'paid')->count() ?? 0); ?> paid
                        </span>
                        <span style="font-size:11px; color:#92400E; background:var(--warning-bg); padding:4px 12px; border-radius:20px;">
                            <i class="ti ti-clock"></i> <?php echo e($driverEarningsThisMonth->where('status', 'pending')->count() ?? 0); ?> pending
                        </span>
                    </div>
                </div>

                <?php if(isset($driverEarningsThisMonth) && $driverEarningsThisMonth->count() > 0): ?>
                <div style="overflow-x:auto;">
                    <table class="driver-earnings-table">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $driverEarningsThisMonth; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $earning): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                ...
                                <td>
                                    <div style="display:flex; align-items:center; gap:8px;">
                                        <div class="driver-avatar" style="width:32px; height:32px; font-size:11px;">
                                            <?php echo e(strtoupper(substr($earning->driver->name ?? 'D', 0, 2))); ?>

                                        </div>
                                        <div>
                                            <div style="font-weight:500; color:var(--gray-900); font-size:13px;"><?php echo e($earning->driver->name ?? 'Unknown Driver'); ?></div>
                                            <div style="font-size:11px; color:var(--gray-500);">ID: #<?php echo e($earning->driver_id); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td style="font-weight:500;"><?php echo e($earning->deliveries_count ?? 0); ?></td>
                                <td style="color:var(--gray-500);"><?php echo e(number_format($earning->total_distance ?? 0, 1)); ?> km</td>
                                <td style="color:var(--gray-500);"><?php echo e(number_format($earning->total_weight ?? 0, 1)); ?> kg</td>
                                <td class="amount" style="text-align:right; font-size:14px;">
                                    <?php echo e(number_format($earning->total_earned ?? 0, 0, ',', ' ')); ?> F
                                </td>
                                <td style="text-align:center;">
                                    <span class="badge-<?php echo e($isPaid ? 'paid' : 'pending'); ?>">
                                        <?php echo e($isPaid ? '✅ Paid' : '⏳ Pending'); ?>

                                    </span>
                                </td>
                                <td style="text-align:center;">
                                    <button class="btn-pay-driver" 
                                            data-driver="<?php echo e($earning->driver_id); ?>" 
                                            data-amount="<?php echo e($earning->total_earned); ?>"
                                            data-name="<?php echo e($earning->driver->name ?? 'Driver'); ?>"
                                            data-deliveries="<?php echo e($earning->deliveries_count ?? 0); ?>"
                                            data-month="<?php echo e(now()->format('F Y')); ?>"
                                            <?php echo e($isPaid ? 'disabled' : ''); ?>>
                                        <i class="ti ti-credit-card"></i> 
                                        <?php echo e($isPaid ? 'Paid' : 'Pay Now'); ?>
            ...
            <div style="background:#FFFFFF; border:0.5px solid var(--gray-200); border-radius:12px; padding:18px 20px; margin-bottom:16px;">
                ...
                <div class="withdrawal-stats">
                    ...
                    <div style="background:var(--gray-50); border-radius:8px; padding:10px 14px; text-align:center; border:0.5px solid var(--gray-200);">
                        ...
                        <div style="font-size:20px; font-weight:700; color:var(--warning); margin-top:2px;">
                            <?php echo e(number_format($pendingAmount ?? 0, 0, ',', ' ')); ?> F
                        </div>
                    </div>
                    <div style="background:var(--gray-50); border-radius:8px; padding:10px 14px; text-align:center; border:0.5px solid var(--gray-200);">
                        <div style="font-size:10px; color:var(--gray-500); text-transform:uppercase; letter-spacing:0.04em; font-weight:500;">
                        ...
                        <div style="font-size:20px; font-weight:700; color:var(--success); margin-top:2px;">
                            <?php echo e(number_format($processedMonth ?? 0, 0, ',', ' ')); ?> F
                        </div>
                    </div>
                </div>
                            ...
                            <tr>
                                <td>
                                    <div style="display:flex; align-items:center; gap:8px;">
                                        ...
                                        <div>
                                            <div style="font-weight:500; color:var(--gray-900); font-size:13px;"><?php echo e($withdrawal->driver->name ?? 'Unknown'); ?></div>
                                            <div style="font-size:10px; color:var(--gray-500);"><?php echo e($withdrawal->driver->user->email ?? 'N/A'); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td style="text-align:right; font-weight:600; color:var(--gray-900);">
                                    <?php echo e($withdrawal->formatted_amount); ?>
                                ...
                                <td style="text-align:center;">
                                    <div style="display:flex; gap:4px; justify-content:center;">
                                        <button class="withdrawal-action-btn approve" 
                                                onclick="approveWithdrawal(<?php echo e($withdrawal->id); ?>, '<?php echo e($withdrawal->driver->name); ?>', '<?php echo e($withdrawal->formatted_amount); ?>')">
                                            <i class="ti ti-check"></i> Approve
                                        </button>
                                        <button class="withdrawal-action-btn reject" 
                                                onclick="rejectWithdrawal(<?php echo e($withdrawal->id); ?>, '<?php echo e($withdrawal->driver->name); ?>', '<?php echo e($withdrawal->formatted_amount); ?>')">
            ...
            <div style="display:grid; grid-template-columns:repeat(4,minmax(0,1fr)); gap:12px; margin-bottom:16px;">
                <a href="<?php echo e(route('admin.drivers')); ?>" class="quick-action-btn">
                    <i class="ti ti-truck" style="color:var(--primary-light);"></i>
                    Drivers
                </a>
                <a href="<?php echo e(route('admin.customers')); ?>" class="quick-action-btn">
                    <i class="fa-solid fa-users" style="color:#3B82F6;"></i>
                    Customers
                </a>
                <a href="<?php echo e(route('admin.orders')); ?>" class="quick-action-btn">
                    <i class="ti ti-package" style="color:var(--warning);"></i>
                    Orders
                </a>
                <a href="<?php echo e(route('admin.users')); ?>" class="quick-action-btn">
            ...
            <div class="dispatch-grid">
                ...
                <div>
                    ...
                    <div class="card-dispatch" style="margin-bottom:18px;">
                        <div class="card-title">
                            <span>📦 Order Queue <span class="badge-count pending"><?php echo e($pendingOrdersCount ?? 0); ?> Pending</span></span>
                            <span style="font-size:12px; color:var(--gray-400);">
                                <i class="ti ti-search"></i> <?php echo e($pendingOrdersCount ?? 0); ?> waiting
                            </span>
                        </div>
                        ...
                        <?php if(isset($pendingOrders) && $pendingOrders->count() > 0): ?>
                            ...
                            <div class="order-item">
                                <div class="order-header">
                                    <span class="order-id"><?php echo e($order->order_number); ?></span>
                                    <span class="order-meta">
                                        <i class="ti ti-user"></i> <?php echo e($order->customer->name ?? 'Customer'); ?>

                                    </span>
                                </div>
                                <div class="order-details">
                                    <span><span class="highlight">Pickup:</span> <?php echo e(Str::limit($order->pickup_address, 25)); ?></span>
                                    <span><span class="highlight">Drop:</span> <?php echo e(Str::limit($order->delivery_address, 25)); ?></span>
                                    <?php if($order->distance_km): ?>
                                        <span><i class="ti ti-route"></i> <?php echo e(number_format($order->distance_km, 1)); ?> km</span>
                                    <?php endif; ?>
                                </div>
                                <div style="display:flex; justify-content:flex-end; margin-top:6px;">
                                    <a href="<?php echo e(route('admin.orders.assign-driver', $order->id)); ?>" class="assign-btn">
                    ...
                    <div class="card-dispatch">
                        <div class="card-title">
                            <span>🔄 Active Orders <span class="badge-count active"><?php echo e($activeOrdersCount ?? 0); ?></span></span>
                        </div>
                        ...
                        <?php if(isset($activeOrders) && $activeOrders->count() > 0): ?>
                            ...
                            <div class="order-item" style="border-left-color:var(--primary-light);">
                                <div class="order-header">
                                    ...
                                    <span class="order-meta" style="color:var(--primary-light);">
                                        ...
                                        <?php if($order->estimated_delivery): ?>
                                            <?php echo e($order->estimated_delivery->diffForHumans()); ?>
                                ...
                                <div class="order-details">
                                    <span><span class="highlight">Driver:</span> <?php echo e(optional($order->driver)->name ?? 'Unassigned'); ?></span>
                                    <span><span class="highlight">Status:</span> <?php echo e(ucfirst(str_replace('_', ' ', $order->status))); ?></span>
                                </div>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
                ...
                <div>
                    ...
                    <div class="card-dispatch">
                        <div class="card-title">
                            <span>👨‍✈️ Drivers <span class="badge-count"><?php echo e($onlineDrivers ?? 0); ?> available</span></span>
                            <span style="font-size:12px; color:var(--gray-400);">
                                <?php echo e($idleDrivers ?? 0); ?> on route · <?php echo e($pendingDrivers ?? 0); ?> awaiting
                            </span>
                        </div>

                        <?php if(isset($availableDrivers) && $availableDrivers->count() > 0): ?>
                            ...
                            <div style="display:flex; align-items:center; gap:10px; padding:8px 0; border-bottom:0.5px solid var(--gray-100);">
                                <div class="driver-avatar"><?php echo e(strtoupper(substr($driver->name ?? 'D', 0, 2))); ?></div>
                                <div style="flex:1;">
                                    <div style="font-size:13px; font-weight:500; color:var(--gray-900);"><?php echo e($driver->name ?? 'Driver'); ?></div>
                                    <div style="font-size:11px; color:var(--gray-500);">
                                        <span class="status-dot available"></span> Available
                                        <?php if($driver->vehicle): ?>
                                            · <?php echo e($driver->vehicle->plate_number); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\logistics_system\resources\views/dashboard/admin.blade.php ENDPATH**/ ?>