...
<?php $__env->startSection('title', 'My Reports - Tracklane'); ?>
<?php $__env->startSection('page-title', 'My Delivery Reports'); ?>
...
<div style="background:#F8FAFC; padding:18px 22px; min-height:560px;">
    ...
    <div style="display:grid; grid-template-columns:repeat(4,minmax(0,1fr)); gap:10px; margin-bottom:16px;">
        ...
        <div class="report-card">
            ...
            <div class="value"><?php echo e(number_format($totalOrders ?? 0)); ?></div>
        </div>
        
        <!-- Delivered -->
        <div class="report-card">
            <div class="label">Delivered</div>
            <div class="value green"><?php echo e(number_format($deliveredOrders ?? 0)); ?></div>
        </div>
        
        <!-- In Transit -->
        <div class="report-card">
            <div class="label">In Transit</div>
            <div class="value orange"><?php echo e(number_format($inTransitOrders ?? 0)); ?></div>
        </div>
        
        <!-- Total Spent -->
        <div class="report-card">
            <div class="label">Total Spent</div>
            <div class="value"><?php echo e(number_format($totalSpent ?? 0, 0, ',', ' ')); ?> F</div>
        </div>
    </div>
    ...
    <div style="background:#FFFFFF; border:0.5px solid #E2E8F0; border-radius:16px; padding:16px; margin-bottom:16px;">
        ...
        <?php if(isset($monthlyOrders) && count($monthlyOrders) > 0): ?>
            <?php
            ...
            <div style="display:flex; align-items:flex-end; gap:12px; height:120px; padding-top:10px;">
                <?php $__currentLoopData = $monthlyOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $month): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $height = max(4, ($month['count'] / $maxCount) * 100);
                    ?>
                    <div style="flex:1; display:flex; flex-direction:column; align-items:center; height:100%;">
                        <div style="font-size:10px; color:#64748B; margin-bottom:4px;"><?php echo e($month['count']); ?></div>
                        <div class="chart-bar" style="height:<?php echo e($height); ?>%;"></div>
                        <div style="font-size:10px; color:#64748B; margin-top:6px;"><?php echo e($month['month']); ?></div>
                    </div>
            ...
            <table style="width:100%; font-size:12px; border-collapse:collapse;">
                ...
                <tbody>
                    ...
                    <tr style="border-bottom:0.5px solid #E2E8F0;">
                        <td style="padding:8px 8px 8px 0; font-weight:500; color:#0F172A;"><?php echo e($order->order_number); ?></td>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\logistics_system\resources\views/reports/customer.blade.php ENDPATH**/ ?>