    ...
    <div class="d-flex align-items-center gap-3">
        ...
        <?php if(auth()->guard()->check()): ?>
            <span class="badge bg-accent-light text-accent px-3 py-1 rounded-pill" 
                ...
                <i class="ti ti-users me-1"></i> <?php echo e(ucfirst(Auth::user()->role)); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\logistics_system\resources\views/layouts/top-nav.blade.php ENDPATH**/ ?>